module Test.PlainArray exposing (tests)
    ...
    let
        ...
        nativeTests =
            describe "Conversion to JS Arrays"
                [ test "jsArrays" <| \() -> Expect.equal (Array.fromList <| List.range 1 1100) (Native.PlainArray.fromJSArray (Native.PlainArray.toJSArray (Array.fromList <| List.range 1 1100)))
                ]
    in
        describe "Array"
            [ creationTests
